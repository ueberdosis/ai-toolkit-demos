...
export default function Page() {
            ...
            renderDecorations(options) {
              return [
                ...
                Decoration.widget(options.range.to, () => {
                  ...
                  element.className = 'ml-2 bg-green-500 text-white px-2 py-1 rounded text-sm hover:bg-green-600'
                ...
                Decoration.widget(options.range.to, () => {
                  ...
                  element.className = 'ml-2 bg-red-500 text-white px-2 py-1 rounded text-sm hover:bg-red-600'
                  element.addEventListener('click', () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="mb-6">
        <EditorContent editor={editor} className="border border-gray-300 rounded-lg p-4 min-h-[200px]" />
      </div>
