...
Rule: When editing the document, ALWAYS provide a brief justification for each change in the meta field. The justification should explain WHY the change improves the document (e.g., "Improves clarity by using active voice", "Fixes grammatical error", "Adds missing context for the reader").
`,
