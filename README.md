...
2. **Set up environment variables:**
   ...
   For the **Server AI Toolkit** demos (`/server-ai-*`), also set the Tiptap Cloud access-control keys (`TIPTAP_AUTH_PRIVATE_KEY`, `TIPTAP_AUTH_ENVIRONMENT_ID`). See `.env.example` for the full list.
